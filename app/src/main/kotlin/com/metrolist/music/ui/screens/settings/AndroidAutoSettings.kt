...
fun AndroidAutoSettings(
    ...
    Column(
        ...
        Material3SettingsGroup(
            title = stringResource(R.string.android_auto_lyrics),
            items = listOf(
                Material3SettingsItem(
                    icon = painterResource(R.drawable.lyrics),
                    title = { Text(stringResource(R.string.android_auto_lyrics)) },
                    description = { Text(stringResource(R.string.android_auto_lyrics_desc)) },
                    trailingContent = {
                        Switch(
                            checked = androidAutoLyrics,
                            onCheckedChange = onAndroidAutoLyricsChange,
                            thumbContent = {
                                Icon(
                                    painter = painterResource(
                                        if (androidAutoLyrics) R.drawable.check else R.drawable.close
                                    ),
                                    contentDescription = null,
                                    modifier = Modifier.size(SwitchDefaults.IconSize),
                                )
